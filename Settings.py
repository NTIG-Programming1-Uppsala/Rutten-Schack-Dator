...
# ALLOWEDMOVE_TILE_COLOR = 'red'
LIGHT_ALLOWEDMOVE_TILE_COLOR = rgb(LIGHT_TILE_COLOR.red, LIGHT_TILE_COLOR.blue*0.6, LIGHT_TILE_COLOR.green*0.84)
DARK_ALLOWEDMOVE_TILE_COLOR = rgb(DARK_TILE_COLOR.red, DARK_TILE_COLOR.blue*0.6, DARK_TILE_COLOR.green*0.84)
